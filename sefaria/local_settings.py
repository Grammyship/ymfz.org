...
DATABASES = {
    'default': {
        ...
        'NAME': '/home/dtnlp/Pecha/Pecha.org/db.sqlite', # Path to where you would like the database to be created including a file name, or path to an existing database file if using sqlite3.
...
ALLOWED_HOSTS = ["localhost", "127.0.0.1","0.0.0.0", "auth.trueming.com"]
...
DEBUG = True
ALLOWED_HOSTS = ['localhost', '127.0.0.1', '[::1]', "auth.trueming.com"]
OFFLINE = False
